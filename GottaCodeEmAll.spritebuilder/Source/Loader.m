...
NSString *testCode = @QUOTE(
    import Foundation; import GottaCodeEmAll; @objc(MyCritter) public class MyCritter : Critter { public func getCurrentStep() -> CodeStep { return CodeStep.Customize };
...
void compile() {
    ...
    dispatch_async(dispatch_get_main_queue(), ^{
        [[CCDirector sharedDirector] replaceScene:[CCBReader loadAsScene:@"Battle"]];
    });
}
